  ...
  return (
    <div id='aboutWrapper'>
      <div id='aboutContent'>
        ...
        <p className='aboutText'>The inspiration to make the calendar came from historian Howard Zinn's book "A People's History of the United States". Zinn's scholarship and political activism demonstrates that, if we are to understand what is how to approach our own struggles today, we have to begin by understanding the history of liberation struggle. Unfortunately, this history is often suppressed, and overwhelming in complexity.</p>
