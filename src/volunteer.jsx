        ...
        <ul>
          <li>
            <p className="volunteerListText">
              ...
              <a className="volunteerLink" target="_blank" rel="noopener noreferrer" href="https://docs.google.com/forms/d/e/1FAIpQLScWvVl15jwOMNyltSzl3elc_mEQzRqamlkKy0HpEvX3fYt_sA/viewform">Make an event suggestion!</a>
            </p>
          </li>
          <li>
            <p className="volunteerListText">
              Are you a developer who has a feature idea?
              <a className="volunteerLink" target="_blank" rel="noopener noreferrer" href="https://github.com/huntzinger92/aPeoplesCalendarWeb">Our code is open-source</a>
              .
            </p>
          </li>
          <li>
            <p className="volunteerListText">
              ...
              <a className="volunteerLink" target="_blank" rel="noopener noreferrer" id="emailLink" href="mailto:apeoplescalendar@gmail.com">email</a>
              .
            </p>
          </li>
        </ul>
